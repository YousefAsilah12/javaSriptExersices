...
//   in   , out
// [ [20  , 0 ]  ,[20,10],[10,15],[0,20]
//         first
//         station


function sleepingPeople(people) {
  let inBus = 0;
  let OutBus = 0;
  ...
  if (inBus - OutBus >= 0) {
    return inBus - OutBus+"  people are still in the bus after the last bus station";

  }
  return "invalid input people out more than in bus";


}
console.log(sleepingPeople([[20, 0], [20, 10],[10,15],[0,20]]));